...
(function(a){a.VertexThree=function(a){this.mesh=a};a.VertexThree.prototype=new a.VertexProxy;a.VertexThree.prototype.constructor=a.VertexThree;a.VertexThree.prototype.setVertex=function(a){this.vertex=a;this.originalX=a.x;this.originalY=a.y;this.originalZ=a.z};a.VertexThree.prototype.getX=function(){return this.vertex.x};a.VertexThree.prototype.getY=function(){return this.vertex.y};a.VertexThree.prototype.getZ=function(){return this.vertex.z};a.VertexThree.prototype.setX=function(a){if(a!=this.vertex.x){var b=
this.mesh;b.geometry.verticesNeedUpdate=!0;b.geometry.normalsNeedUpdate=!0;b.geometry.buffersNeedUpdate=!0;b.geometry.dynamic=!0}this.vertex.x=a};a.VertexThree.prototype.setY=function(a){if(a!=this.vertex.y){var b=this.mesh;b.geometry.verticesNeedUpdate=!0;b.geometry.normalsNeedUpdate=!0;b.geometry.buffersNeedUpdate=!0;b.geometry.dynamic=!0}this.vertex.y=a};a.VertexThree.prototype.setZ=function(a){if(a!=this.vertex.z){var b=this.mesh;b.geometry.verticesNeedUpdate=!0;b.geometry.normalsNeedUpdate=!0;
b.geometry.buffersNeedUpdate=!0;b.geometry.dynamic=!0}this.vertex.z=a}})(MOD3);
...
(function(a){a.VertexPre3D=function(){};a.VertexPre3D.prototype=new a.VertexProxy;a.VertexPre3D.prototype.constructor=a.VertexPre3D;a.VertexPre3D.prototype.setVertex=function(a){this.vertex=a;this.originalX=a.x;this.originalY=a.y;this.originalZ=a.z};a.VertexPre3D.prototype.getX=function(){return this.vertex.x};a.VertexPre3D.prototype.getY=function(){return this.vertex.y};a.VertexPre3D.prototype.getZ=function(){return this.vertex.z};a.VertexPre3D.prototype.setX=function(a){this.vertex.x=a};a.VertexPre3D.prototype.setY=
function(a){this.vertex.y=a};a.VertexPre3D.prototype.setZ=function(a){this.vertex.z=a}})(MOD3);
...
(function(a){a.VertexCopperlicht=function(a,b){this.node=a;this.buffer=b};a.VertexCopperlicht.prototype=new a.VertexProxy;a.VertexCopperlicht.prototype.constructor=a.VertexCopperlicht;a.VertexCopperlicht.prototype.setVertex=function(a){this.vertex=a;this.originalX=this.vertex.Pos.X;this.originalY=this.vertex.Pos.Y;this.originalZ=this.vertex.Pos.Z};a.VertexCopperlicht.prototype.getX=function(){return this.vertex.Pos.X};a.VertexCopperlicht.prototype.getY=function(){return this.vertex.Pos.Y};a.VertexCopperlicht.prototype.getZ=
function(){return this.vertex.Pos.Z};a.VertexCopperlicht.prototype.setX=function(a){var b=this.vertex.Pos.X;this.vertex.Pos.X=a;b!=a&&this.buffer.update(!0)};a.VertexCopperlicht.prototype.setY=function(a){var b=this.vertex.Pos.Y;this.vertex.Pos.Y=a;b!=a&&this.buffer.update(!0)};a.VertexCopperlicht.prototype.setZ=function(a){var b=this.vertex.Pos.Z;this.vertex.Pos.Z=a;b!=a&&this.buffer.update(!0)}})(MOD3);
...
a.y;this.mesh.Pos.Z+=a.z}})(MOD3);(function(a){a.LibraryCubicVR=function(){this.id="CubicVR.js";this.meshClass=a.MeshCubicVR;this.vertexClass=a.VertexCubicVR};a.LibraryCubicVR.prototype=new a.Library3d;a.LibraryCubicVR.prototype.constructor=a.LibraryCubicVR})(MOD3);
(function(a){a.VertexCubicVR=function(a){this.sceneObject=a};a.VertexCubicVR.prototype=new a.VertexProxy;a.VertexCubicVR.prototype.constructor=a.VertexCubicVR;a.VertexCubicVR.prototype.setVertex=function(a){this.vertex=a;this.originalX=a[0];this.originalY=a[1];this.originalZ=a[2]};a.VertexCubicVR.prototype.getX=function(){return this.vertex[0]};a.VertexCubicVR.prototype.getY=function(){return this.vertex[1]};a.VertexCubicVR.prototype.getZ=function(){return this.vertex[2]};a.VertexCubicVR.prototype.setX=
function(a){if(a!=this.vertex[0])this.sceneObject.dirty=!0;this.vertex[0]=a};a.VertexCubicVR.prototype.setY=function(a){if(a!=this.vertex[1])this.sceneObject.dirty=!0;this.vertex[1]=a};a.VertexCubicVR.prototype.setZ=function(a){if(a!=this.vertex[2])this.sceneObject.dirty=!0;this.vertex[2]=a}})(MOD3);
(function(a){a.MeshCubicVR=function(){};a.MeshCubicVR.prototype=new a.MeshProxy;a.MeshCubicVR.prototype.setMesh=function(c){this.sceneObject=c;a.MeshProxy.prototype.setMesh.call(this,c.obj);for(var b=[],d=0,e=c.obj.points,f=e.length,g=c.obj.faces,h=g.length,i,d=0;d<f;)i=new a.VertexCubicVR(c),i.setVertex(e[d]),this.vertices.push(i),b[e[d]]=i,d++;for(d=0;d<h;){c=new a.FaceProxy;f=0;for(i=g[d].points.length;f<i;f++)c.addVertex(b[e[g[d].points[f]]]);this.faces.push(c);d++}delete lookup};a.MeshCubicVR.prototype.updateMeshPosition=
function(a){this.sceneObject.position[0]+=a[0];this.sceneObject.position[1]+=a[1];this.sceneObject.position[2]+=a[2]}})(MOD3);
