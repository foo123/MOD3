(function(window){
    ...
    **/
    ...
    // 3D Flip Book -------------------------------------------------------------------------------------------
    var self={}, THREE=window.THREE, TWEEN=window.TWEEN, MOD3=window.MOD3;
    ...
    self.Book.prototype=new THREE.Object3D();
    self.Book.prototype.constructor=self.Book;
    self.Book.prototype.getNumPages=function()
    {
        return(this.pages.length);
    };
    self.Book.prototype.addPage=function(pf, pb, hardness, pageColor)
    {
    ...
    self.Page.prototype=new THREE.Mesh();
    self.Page.prototype.constructor=self.Page;
    self.Page.prototype.flipLeft=function(pt)
    {
    ...
    self.Page.prototype.flipRight=function(pt)
    {
    ...
    self.Page.prototype.renderFlip=function()
    {
        var p2=Math.PI*0.5;
        ...
        this.page.bend.force = ((Math.abs(this.angle)-p2)/p2)*tt*this.page.force*(1-this.page.pageHardness);
        this.page.bend.offset = (1-tt)*0.6+tt*0.5;
        this.page.mod.apply();
    };
    self.Page.prototype.flipFinished=function()
    {
